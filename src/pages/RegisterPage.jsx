...
import { 
  Flame, Mail, Lock, Eye, EyeOff, CheckCircle2, 
  ...
  const Logo = () => (
    <div className="flex items-center gap-2">
      ...
      <div>
        ...
        <span className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400"> Sécurité</span>
      </div>
    </div>
  );
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-black flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-gray-400 mb-6">
            Un email de confirmation a été envoyé à <span className="text-white font-medium">{email}</span>
          </p>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12">
          ...
          <h1 className="text-4xl font-bold text-white mt-12 mb-4">
            Gérez votre activité <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400">sécurité incendie</span>
          </h1>
